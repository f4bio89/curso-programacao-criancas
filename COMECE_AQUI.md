# 💡 Comece aqui — Code Aventura

Bem-vindos! O **Code Aventura** é uma jornada de 24 missões para uma criança de aproximadamente 10 anos aprender a usar o computador, pensar como programadora e criar projetos próprios.

Não é uma escola com provas. É uma aventura prática: **pensar → testar → errar → investigar → criar → explicar**.
...
| Fase | Missões | O que ela faz |
|---|---:|---|
| Exploradora Digital | 01–03 | Usa computador, arquivos e internet com segurança. |
| Pensamento Lógico | 04–06 | Aprende instruções, repetição e decisões com desafios práticos. |
| Scratch | 07–11 | Cria animações e um jogo completo. |
| Python | 12–18 | Transforma ideias em código no Thonny. |
| Jogos e Programas | 19–22 | Combina conceitos em jogos e programas divertidos. |
| Projeto Final | 23–24 | Escolhe, cria, testa e apresenta uma invenção própria. |
...
- Pop!_OS, navegador, teclado e mouse;
- Scratch nas Missões 07–11;
- Thonny + Python 3 nas Missões 12–24;
- papel e lápis nas primeiras missões de lógica.

Siga `setup/instalar_ferramentas.md` e `setup/verificar_ambiente.md` antes da Missão 01.

## Regra de ouro

Bugs são pistas. Quando algo não funciona, digam: **“O que esperávamos? O que aconteceu? Qual pequena coisa podemos testar agora?”**
